<p><strong>HOMEWORK WEEK 6</strong></p>
...
<p>In this work I will analyze how she has varied throughout his albums of musical genres, from pop, R&B, blues, dance pop, electropop, soul, hip hop and circus style. To do this, I will choose several songs from each album, based also on the list <em>This is: Christina Aguilera</em> of Spotify, in order to analyze which genre is exposed in each album. Therefore, some of the songs to be analysed according to the genre will be: <em>Fighter</em>, <em>Lady Marmalade</em>, <em>Candyman</em>, <em>Dirrty</em> (feat. Redman), <em>Ain't no other man</em> or <em>Genie in a bottle</em>. Finally, and after giving each album a specific genre or majority (since some albums have several genres in it) I will analyze thanks to RStudio data which album, and thus which genre, had more popularity.</p>
<html>
<body>
